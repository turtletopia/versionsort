test_that("vsort works", {
  ...
  expect_equal(
    vsort(c("0.2.0", "0.2.1", "0.2.2", "0.2.5.2", "0.2.5.3", "0.2.5.4", "0.3.0")),
    c("0.2.0", "0.2.1", "0.2.2", "0.2.5.2", "0.2.5.3", "0.2.5.4", "0.3.0")
  )

  # lme version codes
  expect_equal(
    vsort(c("3.0-0 (1999/06/26)", "3.0b8a-2 (1999/06/07)", "3.1-0 (1999/08/03)")),
    c("3.0-0 (1999/06/26)", "3.0b8a-2 (1999/06/07)", "3.1-0 (1999/08/03)")
  )

  # subplex version codes
  expect_equal(
    vsort(c("1.0-10", "1.0-11", "1.1-1", "1.1-2", "1.1-3", "1.1-4", "1.1-6", "1.2-2",
  ...
  expect_equal(
    vsort(c("1.0-1", "1.0-2", "1.0-6", "1.0-8", "1.0-9", "1.0-10", "1.0-11", "1.0-12",
